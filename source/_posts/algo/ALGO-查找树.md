...
首先我们设定新插入的节点N的颜色永远是红色，然后在对红黑树进行修正的时候，我们需要关心新节点N，父节点P，祖父节点G和叔父节点U四个位置。
...
此时，因为在父节点一层的颜色不统一，就不能简单的通过修改颜色来进行调整。

那么要怎么样才能修改颜色呢？很简单，让父节点一层的颜色统一起来。具体采取的方法就是旋转。通过在祖父节点上进行左、右旋，配合节点颜色的变更，即可完成调整。
